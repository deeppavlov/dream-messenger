...
export const RIGHT_SP_IS_ACTIVE = 'RIGHT_SP_IS_ACTIVE'
export const TOKEN_KEY_MODAL_IS_OPEN = 'TOKEN_KEY_MODAL_IS_OPEN'
export const SHARE_MODAL_IS_OPEN = 'SHARE_MODAL_IS_OPEN'
export const KEYS_MISSING = 'KEYS_MISSING'
export const TRIGGER_RIGHT_SP_EVENT = 'TRIGGER_RIGHT_SP_EVENT'
export const ACTIVE_ASSISTANT_SP_ID = 'ACTIVE_ASSISTANT_SP_ID'
export const START_DIALOG_MODAL_IS_OPEN = 'START_DIALOG_MODAL_IS_OPEN'
